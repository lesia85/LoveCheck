...
async def get_about_project_text() -> str:
    ...
    text = (
        ...
        "<b>Цели проекта</b> 🎯\n"
        "<blockquote expandable>Помочь вам объективно оценить текущие отношения и личный комфорт, "
        "а также проверить, может ли нейросеть воссоздать образ «идеального партнера» "
        "и поддерживать с ним осмысленный диалог.</blockquote>\n\n"

        "<b>Методика исследования</b> 🔬\n"
        "<blockquote expandable>В основе лежат два опросника:\n"
        "• Триангулярная теория любви Стернберга (TLS-15)\n"
        "• Опросник черт идеального партнера (IPRS)\n\n"
        "Для генерации текстовых интерпретаций используется нейросеть <b>Gemini</b>.</blockquote>\n\n"

        "<b>Поддержка</b> 💬\n"
        "Заметили ошибку или есть вопрос?\n"
        "Заполните форму, мы обязательно ее рассмотрим: <b>https://forms.gle/HQwUZ2hYwaxmoDLU7</b>"
    )
    return text
